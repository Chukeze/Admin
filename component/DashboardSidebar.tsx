...
import { AdminAccess, EngineerAccess, HRAccess, MaintenanceAccess, SalesAccess } from './DashboardSidebarItems';
...
export const DashboardSidebarWithRoleAccess = (RoleBasedAccess(DashboardSidebar,[UserRole.ADMIN,UserRole.HR,UserRole.ENGINEER,UserRole.MAINTENANCE,UserRole.SALES]));
